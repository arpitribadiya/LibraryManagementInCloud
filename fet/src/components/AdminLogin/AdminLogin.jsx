...
useEffect(() => {
    axios.post(`http://${process.env.REACT_APP_BACKEND_URL}/utils/uploadImage`)
    .then(res => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const result = await axios.post(`http://${process.env.REACT_APP_BACKEND_URL}/admins/loginAdmin`, { username: username, password: password });
    ...
    <>
      <StyledLoginImgWrapper className="login-img-wrapper">
        <StyledLogin className="login-form" onSubmit={handleSubmit}>
          ...
          <Link to="/loginLibrarian">Librarian Login</Link>
        </StyledLogin>
